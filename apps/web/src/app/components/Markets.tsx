...
import { Ticker } from "../utils/types.ts";
        ...
        <p
          className={
            parseFloat(market.priceChangePercent) >= 0
              ? "text-base font-medium tabular-nums text-green-500"
              : "text-base font-medium tabular-nums text-red-500"
          }
        >
          {parseFloat(market.priceChangePercent).toFixed(3)} %
        </p>
      </td>
    </tr>
  );
