      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col px-3">
                ...
                <div className="flex flex-col relative">
                  ...
                  <div className="flex flex-row absolute right-1 top-1 p-2">
                    <div className="relative">
                      <img
                        src="https://backpack.exchange/_next/image?url=%2Fcoins%2Fusdc.png&w=32&q=75"
                        className="w-6 h-6"
                      />
                    </div>
                  </div>
            ...
            <button
              type="button"
              className="font-semibold focus:ring-blue-200 focus:outline-none text-center h-12 rounded-xl text-base px-4 py-2 my-4 bg-green-500 active:scale-98"
